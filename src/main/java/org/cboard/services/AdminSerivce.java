...
//        userDao.saveUserAuthority(userId,cityIdArr);
//
...
//    }
    ...
    public String updateUserAuthority(String userId, String cityNameArr)
    {
        userDao.deleteUserAuthorityByUserId(userId);
        DashboardUserAuthority userAuthority = new DashboardUserAuthority();
        userAuthority.setUserId(userId);
        userAuthority.setCityNameArr(cityNameArr);
        userDao.saveUserAuthority(userAuthority);
        return "1";
    }
